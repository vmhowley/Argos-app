...
const Map = forwardRef<MapRef, MapProps>(function Map(
  { children, theme: themeProp, styles, projection, center, zoom, ...props },
  ref
) {
  ...
  // Handle dynamic view updates (center/zoom)
  useEffect(() => {
    if (!mapInstance) return;

    // Only flyTo if center is provided and different
    if (center) {
      mapInstance.flyTo({
        center: center as [number, number],
        zoom: zoom ?? mapInstance.getZoom(),
        speed: 2, // 1.2 is default, 2 is faster
      });
    }
